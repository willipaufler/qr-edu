# Anstieg an einer Stelle - Tipp

### Zu Teilaufgabe a)
Der Differenzenquotient an einer Stelle $x_0$ ist allgemein gegeben durch:
...
### Zu Teilaufgabe b)
Um den Anstieg (die Momentanrate) zu berechnen, musst du den Grenzwert (Limes) des Differenzenquotienten für $h \to 0$ bestimmen. Der Grenzwert des Differenzenquotienten wird Differentialquotient genannt.
