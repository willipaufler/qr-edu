...
* **Tipp für das Gegenbeispiel:** Nutze die einfachsten Vektoren des dreidimensionalen Raums – die Standard-Basisvektoren der Koordinatenachsen:
  $$
  ...
  $$
  Erinnere dich daran, wie diese orthogonalen Einheitsvektoren über das Kreuzprodukt miteinander verknüpft sind (z. B. $\vec{e}_1 \times \vec{e}_2 = \vec{e}_3$ und $\vec{e}_1 \times \vec{e}_1 = \vec{0}$). Setze für $\vec{a}$, $\vec{b}$ und $\vec{c}$ geschickt diese Basisvektoren ein und berechne beide Seiten separat.