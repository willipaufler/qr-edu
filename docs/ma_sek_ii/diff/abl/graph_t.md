...
### Zu Teilaufgabe c)
Hier musst du "rückwärts" denken:
* Wenn $f$ eine **Nullstelle** hat, muss dein neuer Graph $F$ dort eine waagerechte Tangente (also einen HP oder TP) haben.
* Wenn $f$ oberhalb der x-Achse verläuft, muss dein Graph $F$ in diesem Bereich steigen.