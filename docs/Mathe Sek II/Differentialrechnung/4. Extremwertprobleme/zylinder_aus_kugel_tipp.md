...
$$
Stelle diese Gleichung nach $r^2$ um, da $r^2$ direkt in der Volumenformel vorkommt.

### 3. Zielfunktion
Das Volumen eines Zylinders berechnet sich durch:
$$
V = \pi \cdot r^2 \cdot h
$$
Ersetze $r^2$ durch den Ausdruck aus der Nebenbedingung, um $V(h)$ zu erhalten.
