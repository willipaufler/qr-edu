...
1. **Querschnittsfläche:**
   $A = |\int_{-4}^{4} (\frac{1}{4}x^2 - 4) \, dx| = |[\frac{1}{12}x^3 - 4x]_{-4}^{4}|$
   $A = |(\frac{64}{12} - 16) - (-\frac{64}{12} + 16)| = |(5,33 - 16) - (-5,33 + 16)| = |-21,33| = 21,33 \text{ dm}^2$.
2. **Volumen:**
   Länge $L = 12 \text{ m} = 120 \text{ dm}$.
   $V = 21,33 \text{ dm}^2 \cdot 120 \text{ dm} = 2560 \text{ dm}^3$.
...
3. Flächeninhalt des Wassers: $A_W = \int_{-2}^{2} (-3 - (\frac{1}{4}x^2 - 4)) \, dx = \int_{-2}^{2} (1 - \frac{1}{4}x^2) \, dx$
   $A_W = [x - \frac{1}{12}x^3]_{-2}^{2} = (2 - \frac{8}{12}) - (-2 + \frac{8}{12}) = \frac{4}{3} - (-\frac{4}{3}) = \frac{8}{3} \text{ dm}^2$.
4. Wasservolumen: $V_W = \frac{8}{3} \cdot 120 = 320 \text{ Liter}$.
...
3. Ansatz für Höhe $h$ (Integrationsgrenze $k = \sqrt{4h}$): $\int_{-\sqrt{4h}}^{\sqrt{4h}} ((-4+h) - f(x)) \, dx = 1,25$.
   Durch Lösen der Gleichung (oder systematisches Probieren/CAS) ergibt sich:
