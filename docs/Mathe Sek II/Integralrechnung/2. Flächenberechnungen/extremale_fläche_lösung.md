...
Durch Probieren/CAS finden wir die Nullstelle **$a = 1$** (denn $1-3+2 = 0$).
*(Weitere Nullstellen liegen außerhalb des Intervalls $0 \leq a < 2$.)*

Nachweis mittels 2. Ableitung.
$A''(a) = -3a^2 + 4a$
$A''(1) = 1>0$ also Minimum
...
**Ergebnis:**
Der Flächeninhalt wird für **$a = 1$** minimal. Der minimale Flächeninhalt beträgt **$0,5\,\rm FE$**.